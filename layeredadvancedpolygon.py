...
lpm.loader(mdb, left, bottom, radius, thickness, planethick, data,name="Frame-"+str(layers))

##
##  Apply bc and initiate interactions between planes and polygon
##
for i in range(1, layers+1):
	lpm.bc_bot(mdb, vex, planethick,layer=i, name="Frame-"+str(i))
...
for i in range(1,layers+1):
	if sides !=4:
		lpm.edgeselector(mdb,vex,radius, thickness, sides, apothem,layer=i,name="Frame-"+str(i))
	else:
...
lpm.partition(mdb, arrays[0],arrays[1], radius, distance, thickness)
##
##  Generate mesh
##
p = mdb.models['standard'].parts['Frame']
